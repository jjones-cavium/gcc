...
extern gimple_opt_pass *make_pass_profile_loop_bounds (gcc::context *ctxt);
...
extern gimple_opt_pass *make_pass_merge_common_code (gcc::context *ctxt);
extern gimple_opt_pass *make_pass_merge_const_bfstores (gcc::context *ctxt);
