...
{
  return tree_ssa_phiopt_worker (false, false);
}
...
{
  return tree_ssa_phiopt_worker (false, true);
}
...
static unsigned int
tree_ssa_phiopt_worker (bool late, bool do_store_elim)
{
  basic_block bb;
...
struct gimple_opt_pass pass_late_phiopt =
{
 {
  GIMPLE_PASS,
  "late_phiopt",			/* name */
  NULL,					/* gate */
  tree_ssa_late_phiopt,			/* execute */
  NULL,					/* sub */
  NULL,					/* next */
  0,					/* static_pass_number */
  TV_TREE_PHIOPT,			/* tv_id */
