    ...
    || aarch64_reg_or_zero (operands[1], <MODE>mode))"
{
   switch (which_alternative)
     ...
     case 1: return "mov\\t%w0, %1";
     case 2:
      if (INTVAL (operands[1]) != 0 && INTVAL (operands[1]) % 0x100 == 0)
	{
	  operands[1] = GEN_INT (INTVAL (operands[1]) >> 8);
	  return \"movi\\t%0.<Vallxd>, %1, lsl 8\";
	}
      else
	return \"movi\\t%0.<Vallxd>, %1\";
     case 3: return "ldr<size>\\t%w0, %1";
     case 4: return "ldr\\t%<size>0, %1";
     case 5: return "str<size>\\t%w1, %0";
     case 6: return "str\\t%<size>1, %0";
     case 7: return "umov\\t%w0, %1.<v>[0]";
     case 8: return "dup\\t%0.<Vallxd>, %w1";
     case 9: return "dup\\t%0, %1.<v>[0]";
